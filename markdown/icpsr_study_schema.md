...
**Usage Notes:** A principal investigator (PI) may be a person or an organization; use the Person or Organization element as required. If the PI is identified as a person, their affiliated organization (if applicable) should be included in the Organization element.  
...
For the names of people:   
  ...
  * The given (i.e., 'first') name may include a middle name or initial. If the person only uses an inital for the given name, do not include a space between first and middle initials.  
...
Additional points regarding affiliated organizations:  
  ...
  * If a PI's organizational affiliation is not known, use the term 'Unknown' for the PI Organization element.  
...
| One of(Option)                                   |
| ------------------------------------------------ |
| [item 0](#principal_investigator_items_oneOf_i0) |
| [item 1](#principal_investigator_items_oneOf_i1) |
...
###### <a name="autogenerated_heading_4"></a>8.1.1.1. The following properties are required
* person
...
###### <a name="autogenerated_heading_5"></a>8.1.2.1. The following properties are required
* organization

##### <a name="principal_investigator_items_person"></a>8.1.3. Person
...
###### <a name="principal_investigator_items_person_given_name"></a>8.1.3.1. Given Name
...
###### <a name="principal_investigator_items_person_family_name"></a>8.1.3.2. Family Name
...
##### <a name="principal_investigator_items_organization"></a>8.1.4. Organization
...
##### <a name="principal_investigator_items_order"></a>8.1.5. Order
...
#### <a name="autogenerated_heading_6"></a>10.1. Subfields:
...
#### <a name="autogenerated_heading_7"></a>13.1. Subfields:
...
#### <a name="autogenerated_heading_13"></a>18.1. Subfields:
...
#### <a name="autogenerated_heading_14"></a>19.1. Subfields:
...
#### <a name="autogenerated_heading_22"></a>37.1. Subfields:
...
#### <a name="autogenerated_heading_24"></a>40.1. Subfields:
